...
pub mod constants {
    ...
    pub const SHIFT_WEST_TO_NOEA_MASK: u128 = ((!SHIFT_NOEA_MASK << 12) & !SHIFT_EAST_MASK) << 1;
    pub const SHIFT_WEST_TO_NOWE_MASK: u128 = ((!SHIFT_NOWE_MASK << 11) & !SHIFT_EAST_MASK) << 1;
    pub const SHIFT_WEST_TO_SOEA_MASK: u128 = ((!SHIFT_SOEA_MASK >> 11) & !SHIFT_EAST_MASK) << 1;
    pub const SHIFT_WEST_TO_SOWE_MASK: u128 = ((!SHIFT_SOWE_MASK >> 12) & !SHIFT_EAST_MASK) << 1;
    pub const SHIFT_EAST_TO_WEST_MASK: u128 = ((!SHIFT_WEST_MASK >> 1) & !SHIFT_WEST_MASK) >> 1;
    pub const SHIFT_EAST_TO_NOEA_MASK: u128 = ((!SHIFT_NOEA_MASK << 12) & !SHIFT_WEST_MASK) >> 1;
    pub const SHIFT_EAST_TO_NOWE_MASK: u128 = ((!SHIFT_NOWE_MASK << 11) & !SHIFT_WEST_MASK) >> 1;
    pub const SHIFT_EAST_TO_SOEA_MASK: u128 = ((!SHIFT_SOEA_MASK >> 11) & !SHIFT_WEST_MASK) >> 1;
    pub const SHIFT_EAST_TO_SOWE_MASK: u128 = ((!SHIFT_SOWE_MASK >> 12) & !SHIFT_WEST_MASK) >> 1;
    pub const SHIFT_NOEA_TO_WEST_MASK: u128 = ((!SHIFT_WEST_MASK >> 1) & !SHIFT_SOWE_MASK) >> 12;
    pub const SHIFT_NOEA_TO_EAST_MASK: u128 = ((!SHIFT_EAST_MASK << 1) & !SHIFT_SOWE_MASK) >> 12;
    pub const SHIFT_NOEA_TO_NOWE_MASK: u128 = ((!SHIFT_NOWE_MASK << 11) & !SHIFT_SOWE_MASK) >> 12;
    pub const SHIFT_NOEA_TO_SOEA_MASK: u128 = ((!SHIFT_SOEA_MASK >> 11) & !SHIFT_SOWE_MASK) >> 12;
    pub const SHIFT_NOEA_TO_SOWE_MASK: u128 = ((!SHIFT_SOWE_MASK >> 12) & !SHIFT_SOWE_MASK) >> 12;
    pub const SHIFT_NOWE_TO_WEST_MASK: u128 = ((!SHIFT_WEST_MASK >> 1) & !SHIFT_SOEA_MASK) >> 11;
    pub const SHIFT_NOWE_TO_EAST_MASK: u128 = ((!SHIFT_EAST_MASK << 1) & !SHIFT_SOEA_MASK) >> 11;
    pub const SHIFT_NOWE_TO_NOEA_MASK: u128 = ((!SHIFT_NOEA_MASK << 12) & !SHIFT_SOEA_MASK) >> 11;
    pub const SHIFT_NOWE_TO_SOEA_MASK: u128 = ((!SHIFT_SOEA_MASK >> 11) & !SHIFT_SOEA_MASK) >> 11;
    pub const SHIFT_NOWE_TO_SOWE_MASK: u128 = ((!SHIFT_SOWE_MASK >> 12) & !SHIFT_SOEA_MASK) >> 11;
    pub const SHIFT_SOEA_TO_WEST_MASK: u128 = ((!SHIFT_WEST_MASK >> 1) & !SHIFT_NOWE_MASK) << 11;
    pub const SHIFT_SOEA_TO_EAST_MASK: u128 = ((!SHIFT_EAST_MASK << 1) & !SHIFT_NOWE_MASK) << 11;
    pub const SHIFT_SOEA_TO_NOEA_MASK: u128 = ((!SHIFT_NOEA_MASK << 12) & !SHIFT_NOWE_MASK) << 11;
    pub const SHIFT_SOEA_TO_NOWE_MASK: u128 = ((!SHIFT_NOWE_MASK << 11) & !SHIFT_NOWE_MASK) << 11;
    pub const SHIFT_SOEA_TO_SOWE_MASK: u128 = ((!SHIFT_SOWE_MASK >> 12) & !SHIFT_NOWE_MASK) << 11;
    pub const SHIFT_SOWE_TO_WEST_MASK: u128 = ((!SHIFT_WEST_MASK >> 1) & !SHIFT_NOEA_MASK) << 12;
    pub const SHIFT_SOWE_TO_EAST_MASK: u128 = ((!SHIFT_EAST_MASK << 1) & !SHIFT_NOEA_MASK) << 12;
    pub const SHIFT_SOWE_TO_NOEA_MASK: u128 = ((!SHIFT_NOEA_MASK << 12) & !SHIFT_NOEA_MASK) << 12;
    pub const SHIFT_SOWE_TO_NOWE_MASK: u128 = ((!SHIFT_NOWE_MASK << 11) & !SHIFT_NOEA_MASK) << 12;
    pub const SHIFT_SOWE_TO_SOEA_MASK: u128 = ((!SHIFT_SOEA_MASK >> 11) & !SHIFT_NOEA_MASK) << 12;
}
