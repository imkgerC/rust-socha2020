...
pub mod constants {
    ...
    pub const SHIFT_WEST_TO_EAST_MASK: u128 = super::shift_east(SHIFT_EAST_MASK) | SHIFT_EAST_MASK;
    pub const SHIFT_WEST_TO_NOEA_MASK: u128 = super::shift_east(SHIFT_NOEA_MASK) | SHIFT_EAST_MASK;
    pub const SHIFT_WEST_TO_NOWE_MASK: u128 = super::shift_east(SHIFT_NOWE_MASK) | SHIFT_EAST_MASK;
    pub const SHIFT_WEST_TO_SOEA_MASK: u128 = super::shift_east(SHIFT_SOEA_MASK) | SHIFT_EAST_MASK;
    pub const SHIFT_WEST_TO_SOWE_MASK: u128 = super::shift_east(SHIFT_SOWE_MASK) | SHIFT_EAST_MASK;
    pub const SHIFT_EAST_TO_WEST_MASK: u128 = super::shift_west(SHIFT_WEST_MASK) | SHIFT_WEST_MASK;
    pub const SHIFT_EAST_TO_NOEA_MASK: u128 = super::shift_west(SHIFT_NOEA_MASK) | SHIFT_WEST_MASK;
    pub const SHIFT_EAST_TO_NOWE_MASK: u128 = super::shift_west(SHIFT_NOWE_MASK) | SHIFT_WEST_MASK;
    pub const SHIFT_EAST_TO_SOEA_MASK: u128 = super::shift_west(SHIFT_SOEA_MASK) | SHIFT_WEST_MASK;
    pub const SHIFT_EAST_TO_SOWE_MASK: u128 = super::shift_west(SHIFT_SOWE_MASK) | SHIFT_WEST_MASK;
    pub const SHIFT_NOEA_TO_WEST_MASK: u128 = super::shift_sowe(SHIFT_WEST_MASK) | SHIFT_SOWE_MASK;
    pub const SHIFT_NOEA_TO_EAST_MASK: u128 = super::shift_sowe(SHIFT_EAST_MASK) | SHIFT_SOWE_MASK;
    pub const SHIFT_NOEA_TO_NOWE_MASK: u128 = super::shift_sowe(SHIFT_NOWE_MASK) | SHIFT_SOWE_MASK;
    pub const SHIFT_NOEA_TO_SOEA_MASK: u128 = super::shift_sowe(SHIFT_SOEA_MASK) | SHIFT_SOWE_MASK;
    pub const SHIFT_NOEA_TO_SOWE_MASK: u128 = super::shift_sowe(SHIFT_SOWE_MASK) | SHIFT_SOWE_MASK;
    pub const SHIFT_NOWE_TO_WEST_MASK: u128 = super::shift_soea(SHIFT_WEST_MASK) | SHIFT_SOEA_MASK;
    pub const SHIFT_NOWE_TO_EAST_MASK: u128 = super::shift_soea(SHIFT_EAST_MASK) | SHIFT_SOEA_MASK;
    pub const SHIFT_NOWE_TO_NOEA_MASK: u128 = super::shift_soea(SHIFT_NOEA_MASK) | SHIFT_SOEA_MASK;
    pub const SHIFT_NOWE_TO_SOEA_MASK: u128 = super::shift_soea(SHIFT_SOEA_MASK) | SHIFT_SOEA_MASK;
    pub const SHIFT_NOWE_TO_SOWE_MASK: u128 = super::shift_soea(SHIFT_SOWE_MASK) | SHIFT_SOEA_MASK;
    pub const SHIFT_SOEA_TO_WEST_MASK: u128 = super::shift_nowe(SHIFT_WEST_MASK) | SHIFT_NOWE_MASK;
    pub const SHIFT_SOEA_TO_EAST_MASK: u128 = super::shift_nowe(SHIFT_EAST_MASK) | SHIFT_NOWE_MASK;
    pub const SHIFT_SOEA_TO_NOEA_MASK: u128 = super::shift_nowe(SHIFT_NOEA_MASK) | SHIFT_NOWE_MASK;
    pub const SHIFT_SOEA_TO_NOWE_MASK: u128 = super::shift_nowe(SHIFT_NOWE_MASK) | SHIFT_NOWE_MASK;
    pub const SHIFT_SOEA_TO_SOWE_MASK: u128 = super::shift_nowe(SHIFT_SOWE_MASK) | SHIFT_NOWE_MASK;
    pub const SHIFT_SOWE_TO_WEST_MASK: u128 = super::shift_noea(SHIFT_WEST_MASK) | SHIFT_NOEA_MASK;
    pub const SHIFT_SOWE_TO_EAST_MASK: u128 = super::shift_noea(SHIFT_EAST_MASK) | SHIFT_NOEA_MASK;
    pub const SHIFT_SOWE_TO_NOEA_MASK: u128 = super::shift_noea(SHIFT_NOEA_MASK) | SHIFT_NOEA_MASK;
    pub const SHIFT_SOWE_TO_NOWE_MASK: u128 = super::shift_noea(SHIFT_NOWE_MASK) | SHIFT_NOEA_MASK;
    pub const SHIFT_SOWE_TO_SOEA_MASK: u128 = super::shift_noea(SHIFT_SOEA_MASK) | SHIFT_NOEA_MASK;
}
